<x-filament-widgets::widget>
    <x-filament::section>
        <x-slot name="header">
            <h2 class="text-lg font-medium text-gray-900">Custom Widget</h2>
        </x-slot>
        {{-- CUSTOM COMPONENT --}}
            ...
            <div class="flex items-center">
                ...
                <div class="flex flex-col items-end  gap-y-1">
                    <a href="/idoc" target="_blank"
                        ...
                        <span
                            class="font-semibold group-hover/link:underline group-focus-visible/link:underline text-sm text-gray-700 dark:text-gray-200"
                            style="">
                            Documentación
                        </span>

                    </a>
                    <a href="https://github.com/Is-Chelo" target="_blank"
                        class="fi-link group/link relative inline-flex items-center justify-center outline-none fi-size-md fi-link-size-md gap-1.5 fi-color-gray"
                        rel="noopener noreferrer">
                        <div class="fi-link-icon h-5 w-5 text-gray-400 dark:text-gray-500" style=";">
